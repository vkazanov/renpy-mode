...
cached."
  (let* ((tick   (buffer-chars-modified-tick))
    ...
    (if (and entry (= tick entry-tick))
        entry-data
      (let ((fresh (funcall collector-function)))
...
(defun renpy--collect-labels-cached (&optional _)
...
(defun renpy--collect-images-cached (&optional _)
...
(defun renpy--collect-transforms-cached (&optional _)
