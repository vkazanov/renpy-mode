...
** Completion and jump-to-definition mechanisms
...
The following symbol definitions are recognised and used for both completion and
jump-to-definition mechanisms:
