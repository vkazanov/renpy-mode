...
- [X] document key-bindings/movement in general

- [ ] rework keybindings to be consistent with more popular modes

- [ ] beginning/end of defun should handle top-level statement block?
...
- [X] Run the renpy launcher

- [X] Ren'py launcher integration (see https://github.com/elizagamedev/renpy-mode)

- [ ] Warp to line

  - see https://github.com/furudean/vscode-renpy-warp

  - very important to document limitations:
    https://www.renpy.org/doc/html/developer_tools.html#warping-to-a-line
...
- [ ] block folding, hideshow (or just outline-minor-mode support?)

- [X] Add editor.conf to the package

- [X] new python keywords: case/match/nonlocal

* Document

- [X] More on completion, xref, symbol lookup in general

- [ ] Existing facilities

- [ ] Launcher integration

  env RENPY_EDIT_PY=/home/vkazanov/projects-my/renpy-mode/emacs.edit.py renpy
...
* Publishing
:PROPERTIES:
:ID:       f6ba93a9-e0d9-4fa9-9a82-1a7f59f14dc2
:END:
